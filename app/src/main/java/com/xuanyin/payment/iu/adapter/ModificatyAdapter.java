...
public class ModificatyAdapter extends BaseQuickAdapter<AddingCategories,BaseViewHolder> {

    private Context mContext;
    public ModificatyAdapter(Context context,List<AddingCategories> data) {
        super(R.layout.adapter_modificaty, data);
